...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full bg-[#25D366] shadow-elegant flex items-center justify-center animate-pulse-glow"
    >
